...
public class UserRelationshipServiceTest {
    ...
    @Test
    public void connectByRelationType(){
    ...
    public void addFriend(){
        ...
        StepVerifier.create(userRelationShipService.addFriends(request))
                .expectNextMatches(data -> data.getRelationships().size() == AppConstant.RelationType.FRIEND)
                .verifyComplete();
    }
    ...
    @Test
    public void getFriendsListCanReceiveUpdate(){
        ReceiveUpdateDto.Request request = ReceiveUpdateDto.Request.builder().sender("sender@gmail.com").text("hello! foo@gmail.com").build();
            ...
            Mockito.when(userService.findById(12)).thenReturn(Mono.just(new User(12,"c@gmail.com")));

            StepVerifier.create(userRelationShipService.getFriendsListCanReceiveUpdate(request))
                    .expectNextMatches(data -> data.getRecipients().size() == 3)
                    .verifyComplete();
    }
}
